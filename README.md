...
- Исправлено не корректное сравнение ответов, при выводе в ответе лишнего пробела. Добавил избавление от лишних пробелов опционально (по умолчанию). Для точного сравнения установить в settings.ру опцию CLEAN_SPACES = False
